...
The plot shows a negative relationship between engine size (displ) and fuel efficiency (hwy). In other words, cars with big engines use more fuel. AS engine size increases, fuel efficiency decreases.
...
# Answer:
nrow determines the number of rows the graphs are displayed in. ncol determines the number of columns the graphs are displayed in. as.table will cause the graphs to be layed out as a table and dir will change the direction.
```{r}
